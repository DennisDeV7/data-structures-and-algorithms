...
const howMuchPencil = (str) => {
  ...
  for(i = 0; i < stringArray.length; i++){
    result.push(stringArray.slice(1,-1));
    // let shorterWord = stringArray.slice(0)
    // result.push(shorterWord.join(''));
  }
  return result;
};
